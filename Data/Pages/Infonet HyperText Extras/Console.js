...
function guideMode() {
	...
	startRedirect('./Data/Interactive%20Guide/index.html');
}
...
if (bool == 'true') {
	startRedirect('./Data/Pages/Infonet%20HyperText.html?framemode=teacher');
}
else {
...
var titl = document.getElementById('dropdowntitle'); // Drop down title
	...
	opt1.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?framemode=teacher\');');
	opt2.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=xmos&framemode=teacher\');');
	opt3.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=afs1&framemode=teacher\');');
	opt4.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=afs2&framemode=teacher\');');
...
var titl = document.getElementById('dropdowntitle'); // Drop down title
	...
	opt1.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html\');');
	opt2.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=xmos\');');
	opt3.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=afs1\');');
	opt4.setAttribute('onclick', 'startRedirect(\'./Data/Pages/Infonet%20HyperText.html?mode=afs2\');');
